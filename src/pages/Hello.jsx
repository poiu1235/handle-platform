          ...
          isZero
            ...
            : (() => {
                ...
                return {
                  ...
                  // 无 icon 兜底小圆点（.bd-card-mark）的圈内颜色——用这条余额自己
                  // 的哈希强调色，跟卡片背景同一个色源，不是文字色
                  '--bd-mark-color': colorFor('balance', item.id),
                }
              })()
        }
            ...
            {sorted.map((item, idx) =>
              activeTab === 'balance' ? (
                ...
                <div
                  ...
                  style={{
                    background: colorFor(activeTab, item.id),
                    '--bd-mark-color': colorFor(activeTab, item.id),
                    '--stagger': idx,
                  }}
                >
